...
import com.avis.utils.curlLoggingUtil.CurlLoggingRestAssuredConfigBuilder;
import com.avis.utils.jsonSchemaValidator.JsonSchemaValidation;
...
public class BaseApi {
    ...
    public Response execute() {
        ...
        if (captureAPIDetails) {
            ...
            createAPIPerfReport.captureAPIStatusTimeDTO(baseUri+basePath, this.response.getTimeIn(TimeUnit.MILLISECONDS));
        }
