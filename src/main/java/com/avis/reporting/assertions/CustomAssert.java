package com.avis.reporting.assertions;
...
public class CustomAssert {
    ...
    public static void compareJsonNode(String actualJsonString, String expectedJsonString, String message) {
        try {
            JsonNode actualJsonNode = JacksonJsonImpl.getInstance().toJsonNode(actualJsonString);
            JsonNode expectedJsonNode = JacksonJsonImpl.getInstance().toJsonNode(expectedJsonString);
            CustomAssert.assertEquals(actualJsonNode,expectedJsonNode,message);
        }catch (Exception e){
            System.out.println("Exception occur in json node parsing: "+e);
